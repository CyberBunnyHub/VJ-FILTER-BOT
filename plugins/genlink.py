...
async def gen_link_s(bot, message):
    ...
    file_id, ref, *rest = unpack_new_file_id((getattr(vj, file_type.value)).file_id)
...
async def gen_link_batch(bot, message):
    ...
    file_id, access_hash, file_reference, version, *rest = unpack_new_file_id(post.document.file_id)  
